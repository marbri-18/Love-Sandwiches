...
def get_sales_data():
    ...
    Data must be a string of 6 numbers separated by commas.
    The loop will repeatedthe request for data until it is valid.
    """
...
def update_worksheet(data, worksheet):
    """
    Recieves a list of integers to be appended to a worksheet
...
def calculate_stock_data(data):
    """
    Calculates average sales from last 5 markets plus 10% for recommended next day stock
    """
